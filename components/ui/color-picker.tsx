...
export default function ColorPickerComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[url('https://cdn.pixabay.com/photo/2022/05/31/00/56/sky-7232494_960_720.jpg')] bg-cover">
      {/* Center the color picker card within the screen */}
      <Card className="w-full max-w-md mx-auto p-8 grid gap-8  border-2 border-white bg-gradient-to-t from-yellow-300  via-blue-400 to-pink-400 ">
